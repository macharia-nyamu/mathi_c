...
void test_log_info() {
    ...
    int code = log_info("This is an info message: %d", 123);
...
void test_log_warn() {
    ...
    int code = log_warn("This is a warning message: %s", "be careful");
...
void test_log_error() {
    ...
    int code = log_error("This is an error message");
